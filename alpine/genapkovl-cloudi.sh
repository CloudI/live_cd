...
{services, [
    ...
    %    "/usr/lib/cloudi-1.7.5/tests/hexpi/hexpi_cxx",
    %    % command line arguments for the executable
    %    "",
    %    % {Key, Value} pairs to specify environment variables
    %    [{"LD_LIBRARY_PATH", "/usr/lib/cloudi-1.7.5/api/c/"},
    %     {"DYLD_LIBRARY_PATH", "/usr/lib/cloudi-1.7.5/api/c/"}],
    %    % destination refresh controls how quickly service membership propogates
    %    % Any process that sends to long-lived processes can use
    %    % a 'lazy' prefix destination refresh (otherwise, if sending to
    %    % short-lived provesses, use an 'immediate' prefix destination refresh).
    ...
    [%{type, internal}, % gets inferred
     ...
     {args,
      [{directory, "/usr/lib/cloudi-1.7.5/service_api/dashboard/"}]},
     {dest_refresh, none},
     {count_process, 4}],
    [{prefix, "/cloudi/log/"},
     {module, cloudi_service_filesystem},
     {args,
      [{directory, "/usr/lib/cloudi-1.7.5/logs/"},
    ...
    {internal,
        ...
        [% a maximum of 3 retries will occur if the service request
         ...
         {file, "/usr/lib/cloudi-1.7.5/logs/example_queue_\${I}.log"},
         {compression, 6},
         {checksum, crc32}],
        immediate_closest,
    ...
    {external,
        "/tests/http/",
        "/usr/bin/python3",
        "/usr/lib/cloudi-1.7.5/tests/http/http.py",
        [{"PYTHONPATH", "/usr/lib/cloudi-1.7.5/api/python/"}],
    ...
    %    % enable assertions
    %    "-ea:org.cloudi... "
    %    "-jar /usr/lib/cloudi-1.7.5/tests/http/java/http.jar",
    %    [],
    %    none, default, default,
    ...
    {external,
        "/tests/http/",
        "/usr/bin/ruby",
        "/usr/lib/cloudi-1.7.5/tests/http/http.rb",
        [{"RUBYLIB", "/usr/lib/cloudi-1.7.5/api/ruby/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 4, 5, 300,
        [{nice, 15}]},
    %[{prefix, "/tests/count/"},
    % {file_path, "/usr/lib/cloudi-1.7.5/tests/count/count_go"},
    % {dest_refresh, none},
    % {count_thread, 4},
    % {env, [{"GOMAXPROCS", "4"}]},
    % {options, [{nice, 10}]}],
    %[{prefix, "/tests/count/"},
    % {file_path, "/usr/lib/cloudi-1.7.5/tests/count/count_haskell"},
    % {dest_refresh, none},
    % {count_thread, 4},
    % {options, [{nice, 10}]}],
    %[{prefix, "/tests/count/"},
    % {file_path, "/usr/lib/cloudi-1.7.5/tests/count/count_ocaml"},
    % {dest_refresh, none},
    % {count_thread, 4},
    % {options, [{nice, 10}]}],
    {external,
        "/tests/count/",
        "/usr/lib/cloudi-1.7.5/tests/count/count_c", "",
        [{"LD_LIBRARY_PATH", "/usr/lib/cloudi-1.7.5/api/c/"},
         {"DYLD_LIBRARY_PATH", "/usr/lib/cloudi-1.7.5/api/c/"}],
        none, default, default,
    ...
    %    % enable assertions
    %    "-ea:org.cloudi... "
    %    "-jar /usr/lib/cloudi-1.7.5/tests/count/java/count.jar",
    %    [],
    %    none, default, default,
    %    20000, 5000, 5000, undefined, undefined, 1, 4, 5, 300,
    %    [{nice, 10}]},
    {external,
        "/tests/count/",
        "/usr/bin/node",
        "/usr/lib/cloudi-1.7.5/tests/count/count.js",
        [{"NODE_PATH", "/usr/lib/cloudi-1.7.5/api/javascript/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 4, 1, 5, 300,
        [{nice, 10}]},
    {external,
        "/tests/count/",
        "/usr/bin/perl",
        "/usr/lib/cloudi-1.7.5/tests/count/CountTask.pm",
        [{"PERL5LIB", "/usr/lib/cloudi-1.7.5/api/perl/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 4, 5, 300,
        [{nice, 10}]},
    {external,
        "/tests/count/",
        "/usr/bin/php",
        "-d include_path='/usr/lib/cloudi-1.7.5/api/php/' "
        "-f /usr/lib/cloudi-1.7.5/tests/count/count.php",
        [],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 4, 1, 5, 300,
        [{nice, 10}]},
    {external,
        "/tests/count/",
        "/usr/bin/python3",
        "/usr/lib/cloudi-1.7.5/tests/count/count.py",
        [{"PYTHONPATH", "/usr/lib/cloudi-1.7.5/api/python/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 4, 5, 300,
        [{nice, 10}]},
    {external,
        "/tests/count/",
        "/usr/bin/python3",
        "/usr/lib/cloudi-1.7.5/tests/count/count_c.py",
        [{"PYTHONPATH", "/usr/lib/cloudi-1.7.5/api/python/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 4, 5, 300,
        [{nice, 10}]},
    {external,
        "/tests/count/",
        "/usr/bin/ruby",
        "/usr/lib/cloudi-1.7.5/tests/count/count.rb",
        [{"RUBYLIB", "/usr/lib/cloudi-1.7.5/api/ruby/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 4, 5, 300,
        [{nice, 10}]},
    ...
    % {file_path, "/usr/lib/cloudi-1.7.5/tests/http_req/http_req_go"},
    % {dest_refresh, none},
    % {options,
    %  [{request_timeout_adjustment, true},
    %   {nice, 10}]}],
    %[{prefix, "/tests/http_req/"},
    % {file_path, "/usr/lib/cloudi-1.7.5/tests/http_req/http_req_haskell"},
    % {dest_refresh, none},
    % {options,
    %  [{request_timeout_adjustment, true},
    %   {nice, 10}]}],
    %[{prefix, "/tests/http_req/"},
    % {file_path, "/usr/lib/cloudi-1.7.5/tests/http_req/http_req_ocaml"},
    % {dest_refresh, none},
    % {options,
    %  [{request_timeout_adjustment, true},
    %   {nice, 10}]}],
    {external,
        "/tests/http_req/",
        "/usr/lib/cloudi-1.7.5/tests/http_req/http_req_c", "",
        [{"LD_LIBRARY_PATH", "/usr/lib/cloudi-1.7.5/api/c/"},
         {"DYLD_LIBRARY_PATH", "/usr/lib/cloudi-1.7.5/api/c/"}],
        none, default, default,
    ...
    %    % enable assertions
    %    "-ea:org.cloudi... "
    %    "-jar /usr/lib/cloudi-1.7.5/tests/http_req/java/http_req.jar",
    %    [],
    %    none, default, default,
    ...
    {external,
        "/tests/http_req/",
        "/usr/bin/node",
        "/usr/lib/cloudi-1.7.5/tests/http_req/http_req.js",
        [{"NODE_PATH", "/usr/lib/cloudi-1.7.5/api/javascript/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
        [{request_timeout_adjustment, true},
    ...
    {external,
        "/tests/http_req/",
        "/usr/bin/perl",
        "/usr/lib/cloudi-1.7.5/tests/http_req/http_req.pl",
        [{"PERL5LIB", "/usr/lib/cloudi-1.7.5/api/perl/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
        [{request_timeout_adjustment, true},
    ...
    {external,
        ...
        "/usr/bin/php",
        "-d include_path='/usr/lib/cloudi-1.7.5/api/php/' "
        "-f /usr/lib/cloudi-1.7.5/tests/http_req/http_req.php",
        [],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
        [{request_timeout_adjustment, true},
    ...
    {external,
        "/tests/http_req/",
        "/usr/bin/python3",
        "/usr/lib/cloudi-1.7.5/tests/http_req/http_req.py",
        [{"PYTHONPATH", "/usr/lib/cloudi-1.7.5/api/python/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
        [{request_timeout_adjustment, true},
    ...
    {external,
        "/tests/http_req/",
        "/usr/bin/python3",
        "/usr/lib/cloudi-1.7.5/tests/http_req/http_req_c.py",
        [{"PYTHONPATH", "/usr/lib/cloudi-1.7.5/api/python/"}],
        none, default, default,
    ...
    {external,
        "/tests/http_req/",
        "/usr/bin/ruby",
        "/usr/lib/cloudi-1.7.5/tests/http_req/http_req.rb",
        [{"RUBYLIB", "/usr/lib/cloudi-1.7.5/api/ruby/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
        [{request_timeout_adjustment, true},
    ...
    % {file_path, "/usr/lib/cloudi-1.7.5/tests/null/null_go"},
    % {dest_refresh, none},
    % {options,
    %  [{response_timeout_immediate_max, limit_min},
    %   {nice, 10}]}],
    ...
    %   {nice, 10}]}],
    %[{prefix, "/tests/null/response/"},
    % {file_path, "/usr/lib/cloudi-1.7.5/tests/null/null_haskell"},
    % {dest_refresh, none},
    % {options,
    %  [{response_timeout_immediate_max, limit_min},
    %   {nice, 10}]}],
    ...
    %   {nice, 10}]}],
    %[{prefix, "/tests/null/response/"},
    % {file_path, "/usr/lib/cloudi-1.7.5/tests/null/null_ocaml"},
    % {dest_refresh, none},
    % {options,
    %  [{response_timeout_immediate_max, limit_min},
    %   {nice, 10}]}],
    ...
    {external,
        "/tests/null/response/",
        "/usr/lib/cloudi-1.7.5/tests/null/null_c", "",
        [{"LD_LIBRARY_PATH", "/usr/lib/cloudi-1.7.5/api/c/"},
         {"DYLD_LIBRARY_PATH", "/usr/lib/cloudi-1.7.5/api/c/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
    ...
    %    % enable assertions
    %    "-ea:org.cloudi... "
    %    "-jar /usr/lib/cloudi-1.7.5/tests/null/java/null_.jar",
    %    [],
    %    none, default, default,
    %    20000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
    %    [{response_timeout_immediate_max, limit_min},
    ...
    {external,
        "/tests/null/response/",
        "/usr/bin/node",
        "/usr/lib/cloudi-1.7.5/tests/null/null.js",
        [{"NODE_PATH", "/usr/lib/cloudi-1.7.5/api/javascript/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
        [{response_timeout_immediate_max, limit_min},
    ...
    {external,
        "/tests/null/response/",
        "/usr/bin/perl",
        "/usr/lib/cloudi-1.7.5/tests/null/null.pl",
        [{"PERL5LIB", "/usr/lib/cloudi-1.7.5/api/perl/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
        [{response_timeout_immediate_max, limit_min},
    ...
    {external,
        ...
        "/usr/bin/php",
        "-d include_path='/usr/lib/cloudi-1.7.5/api/php/' "
        "-f /usr/lib/cloudi-1.7.5/tests/null/null.php",
        [],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
        [{response_timeout_immediate_max, limit_min},
    ...
    {external,
        "/tests/null/response/",
        "/usr/bin/python3",
        "/usr/lib/cloudi-1.7.5/tests/null/null.py",
        [{"PYTHONPATH", "/usr/lib/cloudi-1.7.5/api/python/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
        [{response_timeout_immediate_max, limit_min},
    ...
    {external,
        "/tests/null/response/",
        "/usr/bin/python3",
        "/usr/lib/cloudi-1.7.5/tests/null/null_c.py",
        [{"PYTHONPATH", "/usr/lib/cloudi-1.7.5/api/python/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
        [{response_timeout_immediate_max, limit_min},
    ...
    {external,
        "/tests/null/response/",
        "/usr/bin/ruby",
        "/usr/lib/cloudi-1.7.5/tests/null/null.rb",
        [{"RUBYLIB", "/usr/lib/cloudi-1.7.5/api/ruby/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
        [{response_timeout_immediate_max, limit_min},
    ...
    {external,
        "/tests/",
        "/usr/bin/python3",
        "/usr/lib/cloudi-1.7.5/tests/echo/echo.py",
        [{"PYTHONPATH", "/usr/lib/cloudi-1.7.5/api/python/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
        [{nice, 15}]},
    ...
    %    [{directory, "/usr/lib/cloudi-1.7.5/tests/http_req/public_html/"},
    ...
    {external,
        "/tests/websockets/",
        "/usr/bin/python3",
        "/usr/lib/cloudi-1.7.5/tests/websockets/websockets.py",
        [{"PYTHONPATH", "/usr/lib/cloudi-1.7.5/api/python/"}],
    ...
    %    "/tests/environment/",
    %    "/usr/bin/python3",
    %    "/usr/lib/cloudi-1.7.5/tests/environment/environment.py",
    %    [{"PYTHONPATH", "/usr/lib/cloudi-1.7.5/api/python/"},
    %     {"USER", "\${USER}"},
    %     {"\$USER", "user"},
    ...
    % {file_path, "/usr/lib/cloudi-1.7.5/tests/msg_size/msg_size_go"},
    % {options,
    %  [{request_timeout_adjustment, true},
    %   {scope, cloudi_service_test_msg_size},
    %   {nice, 15}]}],
    %[{prefix, "/tests/msg_size/"},
    % {file_path, "/usr/lib/cloudi-1.7.5/tests/msg_size/msg_size_haskell"},
    % {options,
    %  [{request_timeout_adjustment, true},
    %   {scope, cloudi_service_test_msg_size},
    %   {nice, 15}]}],
    %[{prefix, "/tests/msg_size/"},
    % {file_path, "/usr/lib/cloudi-1.7.5/tests/msg_size/msg_size_ocaml"},
    % {options,
    %  [{request_timeout_adjustment, true},
    %   {scope, cloudi_service_test_msg_size},
    %   {nice, 15}]}],
    ...
    %{external,
    %    "/tests/msg_size/",
    %    "/usr/lib/cloudi-1.7.5/tests/msg_size/msg_size_cxx",
    %    "",
    %    [{"LD_LIBRARY_PATH", "/usr/lib/cloudi-1.7.5/api/c/"},
    %     {"DYLD_LIBRARY_PATH", "/usr/lib/cloudi-1.7.5/api/c/"}],
    ...
    %    % enable assertions
    %    "-ea:org.cloudi... "
    %    "-jar /usr/lib/cloudi-1.7.5/tests/msg_size/java/msg_size.jar",
    %    [],
    %    immediate_closest, default, default,
    ...
    %    "/tests/msg_size/",
    %    "/usr/bin/node",
    %    "/usr/lib/cloudi-1.7.5/tests/msg_size/msg_size.js",
    %    [{"NODE_PATH", "/usr/lib/cloudi-1.7.5/api/javascript/"}],
    %    immediate_closest, default, default,
    %    5000, 5000, 5000, [api], undefined, 1, 1, 5, 300,
    %    [{request_timeout_adjustment, true},
    ...
    %    "/tests/msg_size/",
    %    "/usr/bin/perl",
    %    "/usr/lib/cloudi-1.7.5/tests/msg_size/msg_size.pl",
    %    [{"PERL5LIB", "/usr/lib/cloudi-1.7.5/api/perl/"}],
    %    immediate_closest, default, default,
    %    5000, 5000, 5000, [api], undefined, 1, 1, 5, 300,
    %    [{request_timeout_adjustment, true},
    ...
    %    "/usr/bin/php",
    %    "-d include_path='/usr/lib/cloudi-1.7.5/api/php/' "
    %    "-f /usr/lib/cloudi-1.7.5/tests/msg_size/msg_size.php",
    %    [],
    %    immediate_closest, default, default,
    %    5000, 5000, 5000, [api], undefined, 1, 1, 5, 300,
    %    [{request_timeout_adjustment, true},
    ...
    %    "/tests/msg_size/",
    %    "/usr/bin/python3",
    %    "/usr/lib/cloudi-1.7.5/tests/msg_size/msg_size.py",
    %    [{"PYTHONPATH", "/usr/lib/cloudi-1.7.5/api/python/"}],
    %    immediate_closest, default, default,
    %    5000, 5000, 5000, [api], undefined, 1, 1, 5, 300,
    %    [{request_timeout_adjustment, true},
    ...
    %    "/tests/msg_size/",
    %    "/usr/bin/python3",
    %    "/usr/lib/cloudi-1.7.5/tests/msg_size/msg_size_c.py",
    %    [{"PYTHONPATH", "/usr/lib/cloudi-1.7.5/api/python/"}],
    %    immediate_closest, default, default,
    %    5000, 5000, 5000, [api], undefined, 1, 1, 5, 300,
    %    [{request_timeout_adjustment, true},
    ...
    %    "/tests/msg_size/",
    %    "/usr/bin/ruby",
    %    "/usr/lib/cloudi-1.7.5/tests/msg_size/msg_size.rb",
    %    [{"RUBYLIB", "/usr/lib/cloudi-1.7.5/api/ruby/"}],
    %    immediate_closest, default, default,
    %    5000, 5000, 5000, [api], undefined, 1, 1, 5, 300,
    %    [{request_timeout_adjustment, true},
    ...
    % {file_path, "/usr/lib/cloudi-1.7.5/tests/messaging/messaging_go"},
    ...
    % {file_path, "/usr/lib/cloudi-1.7.5/tests/messaging/messaging_haskell"},
    % {dest_refresh, immediate_local},
    % {timeout_async, 10000},
    % {timeout_sync, 10000},
    % {count_thread, 4},
    ...
    % {file_path, "/usr/lib/cloudi-1.7.5/tests/messaging/messaging_ocaml"},
    % {dest_refresh, immediate_local},
    % {timeout_async, 10000},
    % {timeout_sync, 10000},
    % {count_thread, 4},
    ...
    {external,
        ...
        "/usr/bin/perl",
        "/usr/lib/cloudi-1.7.5/tests/messaging/MessagingTask.pm",
        [{"PERL5LIB", "/usr/lib/cloudi-1.7.5/api/perl/"}],
        immediate_local, default, default,
    ...
    {external,
        ...
        "/usr/bin/node",
        "/usr/lib/cloudi-1.7.5/tests/messaging/messaging.js",
        [{"NODE_PATH", "/usr/lib/cloudi-1.7.5/api/javascript/"}],
        immediate_local, default, default,
    ...
    {external,
        ...
        "/usr/bin/php",
        "-d include_path='/usr/lib/cloudi-1.7.5/api/php/' "
        "-f /usr/lib/cloudi-1.7.5/tests/messaging/messaging.php",
        [],
        immediate_local, default, default,
        5000, 10000, 10000, [api], undefined, 4, 1, 5, 300,
    ...
    {external,
        ...
        "/usr/bin/python3",
        "/usr/lib/cloudi-1.7.5/tests/messaging/messaging.py",
        [{"PYTHONPATH", "/usr/lib/cloudi-1.7.5/api/python/"}],
        immediate_local, default, default,
        5000, 10000, 10000, [api], undefined, 1, 4, 5, 300,
    ...
    {external,
        ...
        "/usr/bin/python3",
        "/usr/lib/cloudi-1.7.5/tests/messaging/messaging_c.py",
        [{"PYTHONPATH", "/usr/lib/cloudi-1.7.5/api/python/"}],
        immediate_local, default, default,
        5000, 10000, 10000, [api], undefined, 1, 4, 5, 300,
    ...
    {external,
        ...
        "/usr/bin/ruby",
        "/usr/lib/cloudi-1.7.5/tests/messaging/messaging.rb",
        [{"RUBYLIB", "/usr/lib/cloudi-1.7.5/api/ruby/"}],
        immediate_local, default, default,
        5000, 10000, 10000, [api], undefined, 1, 4, 5, 300,
    ...
    {external,
        "/tests/messaging/cxx/",
        "/usr/lib/cloudi-1.7.5/tests/messaging/messaging_cxx",
        "",
        [{"LD_LIBRARY_PATH", "/usr/lib/cloudi-1.7.5/api/c/"},
         {"DYLD_LIBRARY_PATH", "/usr/lib/cloudi-1.7.5/api/c/"}],
        immediate_local, default, default,
    ...
    %    % enable assertions
    %    "-ea:org.cloudi... "
    %    "-jar /usr/lib/cloudi-1.7.5/tests/messaging/java/messaging.jar",
    %    [],
    %    immediate_local, default, default,
