...
{services, [
    ...
    [%{type, internal}, % gets inferred
     ...
     {args,
      [{directory, "/usr/lib/cloudi-1.7.1/service_api/dashboard/"}]},
     {dest_refresh, none},
     {count_process, 4}],
    [{prefix, "/cloudi/log/"},
     {module, cloudi_service_filesystem},
     {args,
      [{directory, "/usr/lib/cloudi-1.7.1/logs/"},
    ...
    {internal,
        ...
        [% a maximum of 3 retries will occur if the service request
         ...
         {file, "/usr/lib/cloudi-1.7.1/logs/example_queue_\${I}.log"}],
        immediate_closest,
    ...
    {external,
        "/tests/http/",
        "/usr/bin/python3",
        "/usr/lib/cloudi-1.7.1/tests/http/http.py",
    ...
    {external,
        "/tests/http/",
        "/usr/bin/ruby",
        "/usr/lib/cloudi-1.7.1/tests/http/http.rb",
    ...
    {external,
        "/tests/count/",
        "/usr/bin/node",
        "/usr/lib/cloudi-1.7.1/tests/count/count.js",
    ...
    {external,
        "/tests/count/",
        "/usr/bin/perl",
        "/usr/lib/cloudi-1.7.1/tests/count/CountTask.pm",
    ...
    {external,
        ...
        "-f /usr/lib/cloudi-1.7.1/tests/count/count.php",
        [],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 4, 1, 5, 300,
        [{nice, 10}]},
    {external,
        "/tests/count/",
        "/usr/bin/python3",
        "/usr/lib/cloudi-1.7.1/tests/count/count.py",
        [{"PYTHONPATH", "/usr/lib/cloudi-1.7.1/api/python/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 4, 5, 300,
        [{nice, 10}]},
    {external,
        "/tests/count/",
        "/usr/bin/python3",
        "/usr/lib/cloudi-1.7.1/tests/count/count_c.py",
        [{"PYTHONPATH", "/usr/lib/cloudi-1.7.1/api/python/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 4, 5, 300,
        [{nice, 10}]},
    {external,
        "/tests/count/",
        "/usr/bin/ruby",
        "/usr/lib/cloudi-1.7.1/tests/count/count.rb",
        [{"RUBYLIB", "/usr/lib/cloudi-1.7.1/api/ruby/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 4, 5, 300,
        [{nice, 10}]},
    ...
    {external,
        "/tests/http_req/",
        "/usr/bin/node",
        "/usr/lib/cloudi-1.7.1/tests/http_req/http_req.js",
        [{"NODE_PATH", "/usr/lib/cloudi-1.7.1/api/javascript/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
        [{request_timeout_adjustment, true},
    ...
    {external,
        "/tests/http_req/",
        "/usr/bin/perl",
        "/usr/lib/cloudi-1.7.1/tests/http_req/http_req.pl",
        [{"PERL5LIB", "/usr/lib/cloudi-1.7.1/api/perl/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
        [{request_timeout_adjustment, true},
    ...
    {external,
        ...
        "/usr/bin/php",
        "-d include_path='/usr/lib/cloudi-1.7.1/api/php/' "
        "-f /usr/lib/cloudi-1.7.1/tests/http_req/http_req.php",
        [],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
        [{request_timeout_adjustment, true},
    ...
    {external,
        "/tests/http_req/",
        "/usr/bin/python3",
        "/usr/lib/cloudi-1.7.1/tests/http_req/http_req.py",
        [{"PYTHONPATH", "/usr/lib/cloudi-1.7.1/api/python/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
        [{request_timeout_adjustment, true},
    ...
    {external,
        "/tests/http_req/",
        "/usr/bin/python3",
        "/usr/lib/cloudi-1.7.1/tests/http_req/http_req_c.py",
        [{"PYTHONPATH", "/usr/lib/cloudi-1.7.1/api/python/"}],
        none, default, default,
    ...
    {external,
        "/tests/http_req/",
        "/usr/bin/ruby",
        "/usr/lib/cloudi-1.7.1/tests/http_req/http_req.rb",
        [{"RUBYLIB", "/usr/lib/cloudi-1.7.1/api/ruby/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
        [{request_timeout_adjustment, true},
    ...
    {external,
        "/tests/null/response/",
        "/usr/bin/node",
        "/usr/lib/cloudi-1.7.1/tests/null/null.js",
        [{"NODE_PATH", "/usr/lib/cloudi-1.7.1/api/javascript/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
        [{response_timeout_immediate_max, limit_min},
    ...
    {external,
        "/tests/null/response/",
        "/usr/bin/perl",
        "/usr/lib/cloudi-1.7.1/tests/null/null.pl",
        [{"PERL5LIB", "/usr/lib/cloudi-1.7.1/api/perl/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
        [{response_timeout_immediate_max, limit_min},
    ...
    {external,
        ...
        "/usr/bin/php",
        "-d include_path='/usr/lib/cloudi-1.7.1/api/php/' "
        "-f /usr/lib/cloudi-1.7.1/tests/null/null.php",
        [],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
        [{response_timeout_immediate_max, limit_min},
    ...
    {external,
        "/tests/null/response/",
        "/usr/bin/python3",
        "/usr/lib/cloudi-1.7.1/tests/null/null.py",
        [{"PYTHONPATH", "/usr/lib/cloudi-1.7.1/api/python/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
        [{response_timeout_immediate_max, limit_min},
    ...
    {external,
        "/tests/null/response/",
        "/usr/bin/python3",
        "/usr/lib/cloudi-1.7.1/tests/null/null_c.py",
        [{"PYTHONPATH", "/usr/lib/cloudi-1.7.1/api/python/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
        [{response_timeout_immediate_max, limit_min},
    ...
    {external,
        "/tests/null/response/",
        "/usr/bin/ruby",
        "/usr/lib/cloudi-1.7.1/tests/null/null.rb",
        [{"RUBYLIB", "/usr/lib/cloudi-1.7.1/api/ruby/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
        [{response_timeout_immediate_max, limit_min},
    ...
    {external,
        "/tests/",
        "/usr/bin/python3",
        "/usr/lib/cloudi-1.7.1/tests/echo/echo.py",
        [{"PYTHONPATH", "/usr/lib/cloudi-1.7.1/api/python/"}],
        none, default, default,
        5000, 5000, 5000, undefined, undefined, 1, 1, 5, 300,
        [{nice, 15}]},
    ...
    {external,
        "/tests/websockets/",
        "/usr/bin/python3",
        "/usr/lib/cloudi-1.7.1/tests/websockets/websockets.py",
        [{"PYTHONPATH", "/usr/lib/cloudi-1.7.1/api/python/"}],
    ...
    %    "/tests/environment/",
    %    "/usr/bin/python3",
    %    "/usr/lib/cloudi-1.7.1/tests/environment/environment.py",
    %    [{"PYTHONPATH", "/usr/lib/cloudi-1.7.1/api/python/"},
    %     {"USER", "\${USER}"},
    %     {"\$USER", "user"},
    ...
    {external,
        ...
        "/usr/bin/perl",
        "/usr/lib/cloudi-1.7.1/tests/messaging/MessagingTask.pm",
        [{"PERL5LIB", "/usr/lib/cloudi-1.7.1/api/perl/"}],
        immediate_local, default, default,
    ...
    {external,
        ...
        "/usr/bin/node",
        "/usr/lib/cloudi-1.7.1/tests/messaging/messaging.js",
        [{"NODE_PATH", "/usr/lib/cloudi-1.7.1/api/javascript/"}],
        immediate_local, default, default,
    ...
    {external,
        ...
        "/usr/bin/php",
        "-d include_path='/usr/lib/cloudi-1.7.1/api/php/' "
        "-f /usr/lib/cloudi-1.7.1/tests/messaging/messaging.php",
        [],
        immediate_local, default, default,
        5000, 10000, 10000, [api], undefined, 4, 1, 5, 300,
    ...
    {external,
        ...
        "/usr/bin/python3",
        "/usr/lib/cloudi-1.7.1/tests/messaging/messaging.py",
        [{"PYTHONPATH", "/usr/lib/cloudi-1.7.1/api/python/"}],
        immediate_local, default, default,
        5000, 10000, 10000, [api], undefined, 1, 4, 5, 300,
    ...
    {external,
        ...
        "/usr/bin/python3",
        "/usr/lib/cloudi-1.7.1/tests/messaging/messaging_c.py",
        [{"PYTHONPATH", "/usr/lib/cloudi-1.7.1/api/python/"}],
        immediate_local, default, default,
        5000, 10000, 10000, [api], undefined, 1, 4, 5, 300,
    ...
    {external,
        ...
        "/usr/bin/ruby",
        "/usr/lib/cloudi-1.7.1/tests/messaging/messaging.rb",
        [{"RUBYLIB", "/usr/lib/cloudi-1.7.1/api/ruby/"}],
        immediate_local, default, default,
        5000, 10000, 10000, [api], undefined, 1, 4, 5, 300,
    ...
    {external,
        "/tests/messaging/cxx/",
        "/usr/lib/cloudi-1.7.1/tests/messaging/messaging_cxx",
        "",
        [{"LD_LIBRARY_PATH", "/usr/lib/cloudi-1.7.1/api/c/"},
         {"DYLD_LIBRARY_PATH", "/usr/lib/cloudi-1.7.1/api/c/"}],
        immediate_local, default, default,
